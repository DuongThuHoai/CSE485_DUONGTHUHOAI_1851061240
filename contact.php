...
<html lang="en">
  ...
  <div id="block-webform-client-block-22" class="block block-webform form-contact animation-contact contextual-links-region">
    <h2 class="text-center"style=" margin-right: 20px;">Liên hệ với tôi</h2>
    <div class="content">
        ...
        <div class="form-mail-wrap">
          ...
          <div class="form-mail-content">
            ...
            <div class="form-contact-group form-item webform-component webform-component-textfield webform-component--name">
              <label class="element-invisible" for="edit-submitted-name">Tên</label>
              <input placeholder="Nhập vào tên bạn" class="form-control form-contact form-text" type="text" id="edit-submitted-name" name="name" value="" size="60" maxlength="50">
            </div>
            <div class="form-contact-group form-item webform-component webform-component-textfield webform-component--phone">
              <label class="element-invisible" for="edit-submitted-phone">SĐT <span class="form-required" title="phone"></span></label>
              <input required="required" placeholder="Nhập số điện thoại " class="form-control form-contact form-text required" type="text" id="edit-submitted-phone" name="phone" value="" size="60" maxlength="25">
            </div>
            ...
            <div class="form-contact-group form-item webform-component webform-component-textarea webform-component--messages">
              <label class="element-invisible" for="edit-submitted-messages">Lời nhắn</label>
              <div class="form-textarea-wrapper resizable textarea-processed resizable-textarea">
                <textarea placeholder="Lời nhắn" class="form-control form-contact form-textarea" type="text" id="edit-submitted-messages" name="message" cols="60" rows="3"></textarea>
                <div class="grippie"></div>
              </div>
            </div>
          </div>
          <div class="form-actions" >
            <div class="form-actions-wrap"style=" margin-right: 52px;margin-bottom: 200px;height: 100px;">
              <div class="loader-wrap" style="opacity: 0;">
                <div class="loader-20"></div>
              </div>
              <input class="webform-submit button-primary btn btn-primary form-submit" type="submit" name="op" value="Gửi">
